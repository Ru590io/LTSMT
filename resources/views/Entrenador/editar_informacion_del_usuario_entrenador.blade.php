            ...
            <div class="col-md-6">
                ...
                <a href="informacion_del_usuario_entrenador" class="btn btn-primary mb-3">Regresar</a>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="manuel.rosado@upr.edu" pattern=".*@upr\.edu$" title="Debe ser un correo electrónico de UPR." required>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Número de Teléfono</label>
                        <!-- Solo números, 10 dígitos -->
                        <input type="tel" class="form-control" id="phone" name="phone" value="7877355555" pattern="\d{10}" title="Debe ser un número de 10 dígitos." required>
                    </div>
