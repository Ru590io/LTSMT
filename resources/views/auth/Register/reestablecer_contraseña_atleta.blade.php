            ...
            <div class="col-md-6">
                ...
                <form id="passwordForm" class= "form mt-5" action="{{route('password.updated' ['user' => $user->id])}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" class="form-control" @error('password') is-invalid @enderror name="password" required autocomplete="new-password" id="new-password" placeholder="Escriba su nueva contraseña" minlength="8" maxlength="16" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$" title="La contraseña debe contener al menos una letra minúscula, una mayúscula, un número y un carácter especial. Longitud de 8 a 16 caracteres.">
                        @error('password')
