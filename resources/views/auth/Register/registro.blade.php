            ...
            <div class="col-md-6">
                <form class="form mt-5" id="registro" action="{{route('register')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Escriba su nombre (Ej. Juan Carlos)" value="{{ old('first_name') }}" required autocomplete="first_name" autofocus pattern="[a-zA-Z\sáéíóúñ]{1,50}" maxlength="25" title="Solo letras y espacios, hasta 50 caracteres.">
                        @error('first_name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Escriba sus apellidos (Ej. Torrez Figueroa)" value="{{ old('last_name') }}" required autocomplete="last_name" autofocus pattern="[a-zA-Z\sáéíóúñ]{1,50}" maxlength="25" title="Solo letras y espacios, hasta 50 caracteres.">
                        @error('last_name')
                            <span class="d-block fs-6 text-danger mt-2">{{$message}}</span>
                        @enderror
                    </div>
